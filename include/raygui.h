...
// Always enabled Button control, returns true when clicked
int GuiEnabledButton(Rectangle bounds, const char *text)
{
    int result = 0;
...
int GuiValueBoxFloat(Rectangle bounds, const char *text, char *textValue, float *value, bool editMode)
{
    ...
    GuiDrawText(text, textBounds,
                ...
                GetColor(GuiGetStyle(LABEL, _TEXT + (state*3))));
    //--------------------------------------------------------------------
...
int GuiSliderPro(Rectangle bounds, const char *textLeft, const char *textRight, float *value, float minValue, float maxValue, int sliderWidth)
{
    ...
    if (textLeft != NULL)
    {
        ...
        GuiDrawText(textLeft, textBounds, TEXT_ALIGN_RIGHT, GetColor(GuiGetStyle(LABEL, _TEXT + (state*3))));
    }
    ...
    if (textRight != NULL)
    {
        ...
        GuiDrawText(textRight, textBounds, TEXT_ALIGN_LEFT, GetColor(GuiGetStyle(LABEL, _TEXT + (state*3))));
    }
    //--------------------------------------------------------------------
